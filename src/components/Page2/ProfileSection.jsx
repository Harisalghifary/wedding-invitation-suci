...
const ProfileCard = ({ person, title, animationVariant }) => {
    ...
    return (
        <AnimateOnScroll variant={animationVariant} className="relative text-center py-4">
...
export default function ProfileSection() {
    return (
        <SectionWrapper id="profile" background="primary">
            {/* Introduction card */}
            <AnimateOnScroll variant="fadeIn" className="p-6 sm:p-8 text-center max-w-2xl px-4 mx-auto mt-24">
            ...
            {/* The Bride */}
            <ProfileCard person={weddingData.couple.bride} title="The Bride" animationVariant="slideFromLeft" />
