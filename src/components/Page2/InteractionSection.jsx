...
function WishesSection() {
    ...
    return (
        <section className="bg-primary px-6">
            {/* Header */}
            <AnimateOnScroll variant="fadeUp" className="text-center mb-8 relative mx-auto w-fit">
            ...
            {/* Form */}
            <AnimateOnScroll variant="fadeUp" delay={0.15} className="max-w-2xl mx-auto pt-8">
...
function WeddingGiftSection() {
    return (
        <section className="bg-primary pb-16 px-6">
            {/* Header */}
            <AnimateOnScroll variant="fadeUp" className="text-center mb-6">
            ...
            <AnimateOnScroll variant="fadeIn" delay={0.1}>
                <p className="font-dmSans text-xs text-white leading-relaxed max-w-2xl mx-auto text-center">
            ...
            {/* Bank Cards */}
            <StaggerOnScroll className="max-w-2xl mx-auto space-y-6 mt-8">
                {weddingData.bankAccounts.map((bank) => (
                    <MotionChild key={bank.id} variant="fadeUp">
                        <BankCard bank={bank} />
                    </MotionChild>
                ))}
            </StaggerOnScroll>
            ...
            {/* Gift Registry Link */}
            <AnimateOnScroll variant="fadeUp" delay={0.2} className="text-center mt-12 max-w-2xl mx-auto">
